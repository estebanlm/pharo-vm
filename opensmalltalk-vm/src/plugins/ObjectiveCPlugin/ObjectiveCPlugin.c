/* Automatically generated by
	SmartSyntaxPluginCodeGenerator * VMMaker.oscog-eem.2184 uuid: aa9725c6-233f-4e84-9a79-79af2f5465d3
   from
...
primitiveGetAddressFromEntryPointString(void)
{
	...
	entryPointNameLength = slotSizeOf(((sqInt)(sqIntptr_t)(aEntryPointName) - BaseHeaderSize));
...
primitiveGetObjCClassForString(void)
{
	...
	classNameLength = slotSizeOf(((sqInt)(sqIntptr_t)(aClassName) - BaseHeaderSize));
...
primitiveGetSelectorForString(void)
{
	...
	selectorLength = slotSizeOf(((sqInt)(sqIntptr_t)(aSelectorName) - BaseHeaderSize));
...
primitiveNSInvocationSetStringType(void)
{
	...
	stringSize = slotSizeOf(((sqInt)(sqIntptr_t)(aValue) - BaseHeaderSize));
...
primitiveNSInvocationSetStructureType(void)
{
	...
	byteArraySize = slotSizeOf(((sqInt)(sqIntptr_t)(aValue) - BaseHeaderSize));
