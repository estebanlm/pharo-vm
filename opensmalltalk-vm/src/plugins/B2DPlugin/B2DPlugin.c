/* Automatically generated by
   ...
   from
	BalloonEnginePlugin * VMMaker.oscog-eem.2184 uuid: aa9725c6-233f-4e84-9a79-79af2f5465d3
 */
static char __buildInfo[] = "BalloonEnginePlugin * VMMaker.oscog-eem.2184 uuid: aa9725c6-233f-4e84-9a79-79af2f5465d3 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"B2DPlugin * VMMaker.oscog-eem.2184 (i)"
#else
	"B2DPlugin * VMMaker.oscog-eem.2184 (e)"
#endif
;
...
/* begin stackFillValue: */
		...
		l19:	/* end quickRemoveInvalidFillsAt: */;
			startX1 = stopX1;
			/* begin topRightX */
			if (((workBuffer[GWSize]) - (workBuffer[GWBufferTop])) == 0) {
				stopX1 = 999999999;
